...
const form = useForm({
    bank_name: props.affiliate.bank_name ?? '',
    bank_account_number: props.affiliate.bank_account_number ?? '',
    bank_account_name: props.affiliate.bank_account_name ?? '',
});

const submit = (): void => {
    form.patch('/affiliate/dashboard/bank-details');
};
